...
export default function DogPagesClient() {
  ...
  useEffect(() => {
    ...
    const fetchPets = async () => {
      ...
      // This page only ever shows cats, regardless of the species filter UI.
      params.species = "Dog";
  ...
  }, [api, debouncedSearch, selectedGenders, selectedPrices, selectedAges]);
